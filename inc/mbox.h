...
#define MBOX_TAG_MACADDRESS     0x00010003  //Get board MAC address
#define MBOX_TAG_BOARDREVISION  0x00010002  //get board revision
#define MBOX_TAG_LAST           0 

//New Tags for Screen Display

#define MBOX_TAG_GETFB 0x40001
#define MBOX_TAG_BLANKSCREEN 0x40002
